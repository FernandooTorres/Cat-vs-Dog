...
X1 = LoadTraningSet('dog\',input_width,input_height,color);%约束到1
m1 = size(X1,1);
y1 = ones(m1,1) * 1;
X2 = LoadTraningSet('cat\',input_width,input_height,color);
m2 = size(X2,2);
y2 = ones(m2,1) * 2;
%tr = 52;    %拿X的前个训练
...
fprintf('Dog_Precision: %f, Cat_Precision: %f, avg_Precision: %f\n',P,Z,total);
